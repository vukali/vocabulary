...
export const communicationCards = [
  card("hello", "xin chào", "/həˈləʊ/", "interjection", "👋", "Bạn đang vẫy tay chào một người bạn.", { alternativesEn: ["hi", "hey"], alternativesVi: ["chào bạn"], learnerHint: "Trang trọng vừa phải: hello. Thân hơn: hi." }),
  card("please", "làm ơn", "/pliːz/", "interjection", "🙏", "Bạn đang nhờ ai đó giúp mình.", { alternativesVi: ["xin vui lòng"] }),
  card("sorry", "xin lỗi", "/ˈsɒr.i/", "interjection", "🙇", "Bạn làm phiền ai đó và cúi nhẹ đầu xin lỗi.", { alternativesEn: ["i am sorry", "my apologies"], alternativesVi: ["thành thật xin lỗi", "xin lỗi nhé"], learnerHint: "Sai nhẹ thì nói sorry. Trang trọng hơn có thể nói my apologies." }),
  card("thanks", "cảm ơn", "/θæŋks/", "interjection", "💛", "Bạn mỉm cười sau khi được giúp đỡ.", { alternativesEn: ["thank you"], alternativesVi: ["cảm ơn bạn", "cám ơn"] }),
  card("repeat", "lặp lại", "/rɪˈpiːt/", "verb", "🔁", "Người đối diện đang nói lại một lần nữa.", { alternativesVi: ["nhắc lại"] }),
  card("answer", "trả lời", "/ˈɑːn.sər/", "verb", "💬", "Bạn mở miệng đáp lại một câu hỏi.", { alternativesVi: ["đáp lại"] }),
  card("question", "câu hỏi", "/ˈkwes.tʃən/", "noun", "❓", "Một dấu hỏi lớn bật sáng trong đầu.", { alternativesVi: ["câu hỏi thắc mắc"] }),
  card("explain", "giải thích", "/ɪkˈspleɪn/", "verb", "🧠", "Bạn đang vẽ ví dụ để người khác hiểu hơn.", { alternativesVi: ["nói rõ"] }),
  card("message", "tin nhắn", "/ˈmes.ɪdʒ/", "noun", "📩", "Điện thoại vừa hiện lên một tin mới."),
  card("schedule", "lịch", "/ˈskedʒ.uːl/", "noun", "🗓️", "Cuốn lịch mở ra với nhiều mốc giờ.", { alternativesVi: ["lịch trình"] }),
  card("available", "rảnh", "/əˈveɪ.lə.bəl/", "adjective", "🟢", "Một khung giờ trên lịch đang còn trống.", { alternativesVi: ["có thời gian"] }),
  card("busy", "bận", "/ˈbɪz.i/", "adjective", "🔴", "Lịch làm việc kín mít cả ngày."),
  card("meeting", "cuộc họp", "/ˈmiː.tɪŋ/", "noun", "👥", "Hai người đang ngồi trao đổi công việc.", { alternativesVi: ["buổi họp"] }),
  card("colleague", "đồng nghiệp", "/ˈkɒl.iːɡ/", "noun", "🤝", "Bạn bắt tay một người cùng công ty."),
  card("agree", "đồng ý", "/əˈɡriː/", "verb", "👍", "Bạn gật đầu vì thấy đúng.", { alternativesVi: ["tán thành"] }),
  card("disagree", "không đồng ý", "/ˌdɪs.əˈɡriː/", "verb", "👎", "Bạn lắc đầu nhẹ vì chưa cùng quan điểm.", { alternativesVi: ["phản đối"] }),
  card("borrow", "mượn", "/ˈbɒr.əʊ/", "verb", "📚", "Bạn xin mượn tạm một món đồ.", { alternativesVi: ["mượn tạm"] }),
  card("return", "trả lại", "/rɪˈtɜːn/", "verb", "↩️", "Bạn đưa lại món đã mượn.", { alternativesVi: ["hoàn trả"] }),
  card("promise", "hứa", "/ˈprɒm.ɪs/", "verb", "🤞", "Bạn móc ngoéo tay để hứa.", { alternativesVi: ["cam kết"] }),
  card("improve", "cải thiện", "/ɪmˈpruːv/", "verb", "📈", "Đường biểu đồ đang đi lên rõ rệt.", { alternativesVi: ["tiến bộ hơn"] }),
];

export const itCards = [
  card("bug", "lỗi", "/bʌɡ/", "noun", "🐞", "Một con bọ nhỏ đang nằm trong dòng code.", { alternativesVi: ["lỗi phần mềm"] }),
  card("deploy", "triển khai", "/dɪˈplɔɪ/", "verb", "🚀", "Bạn đang đẩy app lên môi trường thật.", { alternativesVi: ["đưa lên chạy"] }),
...
export const devopsCards = [
  card("container", "container", "/kənˈteɪ.nər/", "noun", "📦", "Ứng dụng nằm gọn trong một chiếc hộp.", { alternativesVi: ["vùng chứa ứng dụng"] }),
...
export const homeCards = [
  ...
  card("bathroom", "phòng tắm", "/ˈbɑːθ.ruːm/", "noun", "🛁", "Có vòi nước, gương và bồn rửa.", { alternativesEn: ["restroom", "toilet"], alternativesVi: ["nhà vệ sinh"], learnerHint: "Bathroom là cách trung tính. Khi hỏi đường có thể nghe restroom." }),
...
export const restaurantCards = [
  ...
  card("delicious", "ngon", "/dɪˈlɪʃ.əs/", "adjective", "😋", "Bạn vừa ăn và gật gù rất ngon.", { alternativesVi: ["rất ngon"] }),
  card("hungry", "đói", "/ˈhʌŋ.ɡri/", "adjective", "🍽️", "Bụng đang réo lên trước bữa ăn."),
  card("full", "no", "/fʊl/", "adjective", "🙂", "Bạn đặt tay lên bụng sau khi ăn xong.", { alternativesVi: ["ăn no rồi"] }),
  card("dessert", "tráng miệng", "/dɪˈzɜːt/", "noun", "🍰", "Miếng bánh ngọt sau món chính."),
  card("tip", "tiền boa", "/tɪp/", "noun", "💵", "Bạn để lại ít tiền cảm ơn phục vụ.", { alternativesVi: ["tiền bo"] }),
  card("receipt", "biên lai", "/rɪˈsiːt/", "noun", "🧾", "Nhân viên in ra một mẩu giấy nhỏ."),
  card("fork", "nĩa", "/fɔːk/", "noun", "🍴", "Chiếc nĩa nằm cạnh chiếc đĩa."),
  card("spoon", "thìa", "/spuːn/", "noun", "🥄", "Thìa đang múc một ngụm súp nóng.", { alternativesVi: ["muỗng"] }),
  card("knife", "dao", "/naɪf/", "noun", "🔪", "Con dao đặt cạnh khăn ăn."),
  card("takeaway", "mang về", "/ˈteɪk.ə.weɪ/", "noun", "🥡", "Hộp thức ăn được đóng để mang đi.", { alternativesEn: ["takeout"], alternativesVi: ["mua mang về"], learnerHint: "Anh-Anh hay nói takeaway, Anh-Mỹ hay nói takeout." }),
];
